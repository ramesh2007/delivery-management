            ...
            'items' => $order->items->map(function ($item) {
                return [
                    ...
                    'installation' => $item->installation ? [
                        ...
                        'is_scheduled_assigned' => (bool) ($item->installation->is_scheduled_assigned ?? false),
                    ] : null,
                    'is_scheduled_assigned' => (bool) ($item->installation ? $item->installation->is_scheduled_assigned : false),
